...
public class 제어문정리문제15 {
	...
	public static void main(String[] args) {
		...
		char[] hak=new char[3];
		int[] rank=new int[3];
		//int[][] jumsu=new int[3][7]; ==>2차원 배열로 작성하는 법.
		...
		System.out.printf("%10s%9s%9s%22s%20s%12s%10s\n","국어","영어","수학","총점","평균","학점","순위");
		for(int i=0;i<3;i++){
			System.out.printf("%5d%5d%5d%10d%10.2f%4c%6d\n",kor[i],eng[i],math[i],total[i],avg[i],hak[i],rank[i]);
		}
